...
export const Modal = ({ closeModal, onSubmit, defaultValue }) => {
    const fields = Object.keys(Object.values(dataJSON)[0]).filter((setItem) => !item.startsWith('delta_'));
    ...
    const handleChange = (e) => {
        ...
        console.log(
            e.target.name == 'para' && e.target.value == 'rating' && formState.criterion > 1 && formState.criterion < 4,
        );
        if (
            e.target.name == 'para' &&
